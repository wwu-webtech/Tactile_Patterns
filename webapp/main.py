...
#changed '@babel.localeselector' to 'babel.init_app(app, locale_selector=get_locale)', moved to after get_locale to stop err
...
class UploadForm(FlaskForm):
    ...
    #return #added return statement grabbing photo
    ])
